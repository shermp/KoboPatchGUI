...
class ToolTipBase:
    ...
    def showcontents(self, text="Your text here"):
        ...
        label = Label(self.tipwindow, text=text, justify=LEFT, anchor=W,
                      background="#ffffe0", relief=SOLID, borderwidth=1, width=80)
        label.pack()
...
def main():
    ...
    tip = ToolTip(b, 'This is a long line of text. This is a long line of text. This is a long line of text. This is a long line of text. This is a long line of text. ')
    root.mainloop()
